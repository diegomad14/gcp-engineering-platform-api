...
| T2-B | Registro + recuperación | `/private/tmp/cgm-release-t2-backend` | `e8abc802fbe2496cf3c9a2abb5ed78b0c4ef4ae0` | cgm_backend | routers/stores de release y pruebas focalizadas | T1 integrado | Identidad, idempotencia, conflictos SHA/digest/revisión y recuperación durable | IN_PROGRESS | — | Sin acceso a servicios remotos; requiere revisión Lead |
| T2-P | Providers locales + lifecycle | `/private/tmp/cgm-release-t2-platform` | `e8abc802fbe2496cf3c9a2abb5ed78b0c4ef4ae0` | cgm_platform | lifecycle/CLI, fixtures locales y pruebas focalizadas | T1 integrado | Dry-run y fixtures reproducen publicación/candidate/promote/rollback/resume sin repetir efectos | IN_PROGRESS | — | No build/push/deploy; requiere revisión Lead |
| T2-R | Revisión de carreras | `/private/tmp/cgm-release-t2-review` | `e8abc802fbe2496cf3c9a2abb5ed78b0c4ef4ae0` | cgm_reviewer | ninguno | SHA T1 | Hallazgos reproducibles con archivo/línea y frontera cubierta | IN_PROGRESS | — | Solo lectura; no modifica ni ejecuta pruebas con escritura |
